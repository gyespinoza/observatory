...
const selectedPeriodLabel = computed(() => {
  const found = periodOptions.find((item) => item.value === period.value);
...
const customizeTooltip = (pointInfo) => ({
  text: `${pointInfo.argumentText}: ${pointInfo.valueText} Lb`,
});
...
const exportChart = async () => {
  ...
  img.onload = () => {
    ...
    logo.onload = () => {
      ...
      link.download = `reporte-${selectedPeriodLabel.value}.png`;
    ...
    logo.onerror = () => {
      // Si falla el logo, igual descarga el gráfico
      const link = document.createElement("a");
      link.download = `reporte-${selectedPeriodLabel.value}.png`;
      link.href = canvas.toDataURL("image/png");
      link.click();
    ...
    <div class="stats-chart-card">
      <div class="stats-chart-card__header">
        <div>
          ...
          <h3 class="stats-chart-card__title">Reciclaje por período</h3>
        </div>
      </div>
      ...
      <div class="stats-chart-card__body">
        <div class="chart-topbar">
          <div class="chart-meta">
            ...
            <span class="chart-meta__value">{{ selectedPeriodLabel }}</span>
          </div>
          ...
          <div class="chart-actions">
            <div class="chart-filter-select">
              ...
              <select v-model="period" class="chart-select">
                <option
          ...
          >
            <DxSeries argument-field="year" value-field="total_weight">
              <DxLabel
                ...
                format="fixedPoint"
              >
                <DxConnector :visible="true" :width="2" />
              </DxLabel>
            </DxSeries>
            ...
            <DxExport :enabled="false" :printing-enabled="false" />
